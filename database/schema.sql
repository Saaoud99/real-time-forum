...
--     FOREIGN KEY(user_id) REFERENCES users (id) ON DELETE CASCADE --THIS TAKE THE ID OF THE USER AND PUT IT IN THE USER ID--
-- );
...
-- --THIS TABLE IS FOR CATEGORIES --
-- CREATE TABLE IF NOT EXISTS categories(
--     id INTEGER PRIMARY KEY AUTOINCREMENT,
--     name TEXT NOT NULL UNIQUE
-- );

-- -- THIS TABLE IS FOR POSTS ANDD ITS CATEGORIES
...
-- -- THS TABLE IS FOR REACTIONS (LIKE AND DISLIKE)
